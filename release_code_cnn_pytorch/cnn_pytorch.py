...
class CNN_PyTorch(nn.Module):
    def __init__(self, num_outputs):
        ...
        '''
        Initialize your layers here. Use nn as imported above.
    ...
    def forward(self, x):
        '''
        Compute your forward pass here, using the layers you initialized above.
    ...
    def response_map(self, x):
        '''
        This should be basically one line: return the response Variable from the conv
        '''
